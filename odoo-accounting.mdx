...
In order to get started with our Odoo Accounting integration, you will need to first create an API Key for your Odoo application. After that, you will need to enter your Odoo credentials on RootFi's Connect Link.
