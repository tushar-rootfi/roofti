...
description: "Learn more about how to set up our Microsoft Dynamics 365 Business Central integration."
---

If you wish to set up Microsoft Dynamics 365 Business Central on the RootFi Integrate Portal, you will need to follow the steps outlined below.
...
### Part 5: Enter Your Client ID and Client Secret on the RootFi Integrate Dashboard
