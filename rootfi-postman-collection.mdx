...
> Try out our APIs
> 
> Our Postman collection is live at [https://postman.rootfi.dev](https://postman.rootfi.dev)
...
2. Add your `API_KEY` and ensure `API_URL` is set correctly at the collection level variables  
   1. `API_KEY`: **`API_KEY`**  
   2. `API_URL`: \[https://integrate.rootfi.dev/api\]([https://integrate.rootfi.dev/api](https://integrate.rootfi.dev/api)
...
> 📘
> 
> To read data using GraphQL refer to the [Graphql playground](/docs/graphql-playground)