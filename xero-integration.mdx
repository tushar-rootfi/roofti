---
title: "Xero"
description: "Learn more about how to set up our Xero integration."
---

To start using our Xero integration, you need to first register your Xero application, and then enter your Client ID and Client Secret on the RootFi Integrate dashboard. 
